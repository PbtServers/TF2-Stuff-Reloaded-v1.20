...
public class MapList {
	...
	public static Map<String, CompoundTag> buildInAttributes;

	// public static Map<MinigunLoopSound, LivingEntity > fireCritSounds;
	// public static Map<List<SpawnerData>, SpawnerData> scoutSpawn;
	...
	public static void initMaps() {
		...
		// scoutSpawn=new HashMap<List<SpawnerData>, SpawnerData>();
