...
public class ContainerTF2Workbench extends Container implements IRecipeContainer {
	...
	public ContainerTF2Workbench(Player player, InventoryPlayer inventory, Level world, BlockPos posIn) {
		this.player = player;
		this.world = world;
		this.pos = posIn;
	...
	public static ItemStack getReplacement(Player player, ItemStack stack) {
