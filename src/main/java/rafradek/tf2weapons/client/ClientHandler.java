...
public class ClientHandler {
	...
	public static LivingEntity getClientEntity(int id) {
		return (LivingEntity) Minecraft.getMinecraft().world.getEntityByID(id);
	}
	...
	public static void createGui(ShowGuiMessage message) {
		ListTag listTeams = message.data.getTagList("Teams", 8);
