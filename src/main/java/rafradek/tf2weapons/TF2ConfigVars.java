...
public class TF2ConfigVars {
	...
	public static Map<Class<? extends Mob>, Integer> spawnRate;
	...
	public static void createConfig(boolean save) {
		...
		worldScale = conf.getFloat("Level scale", "adaption", 0.9f, 0f, Float.MAX_VALUE,
		...
		disableGeneration = conf.getBoolean("Disable structures", "Level gen", false,
				"Disable structures generation, such as Mann Co. building");
		mannCoChance = conf.getInt("Mann Co. building chance", "Level gen", 32, 1, Integer.MAX_VALUE,
				"Median chunk distance between Mann Co. buildings");
		baseChance = conf.getInt("Base building chance", "Level gen", 32, 1, Integer.MAX_VALUE,
				"Median chunk distance between base buildings");
		disableLoot = conf.getBoolean("Disable chest loot", "Level gen", false,
		...
		conf.get("Level gen", "Disable structures", false).setRequiresMcRestart(true);
		conf.get("Level gen", "Mann Co. building chance", 32).setRequiresWorldRestart(true);
		conf.get("Level gen", "Mann Co. building chance", 32).setRequiresWorldRestart(true);
