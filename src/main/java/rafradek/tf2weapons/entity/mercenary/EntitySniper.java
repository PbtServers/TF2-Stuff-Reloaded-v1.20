...
public class EntitySniper extends EntityTF2Character {
	...
	public EntitySniper(Level par1World) {
		super(par1World);
		// this.ammoLeft = 18;
	...
	public void onLivingUpdate() {
		if (!this.world.isRemote && this.getHeldItemMainhand().getItem() instanceof ItemSniperRifle
			...
			((ItemSniperRifle) this.getHeldItem(InteractionHand.MAIN_HAND).getItem())
					.disableZoom(this.getHeldItem(InteractionHand.MAIN_HAND), this);
		if (this.getHeldItem(InteractionHand.MAIN_HAND) != null
				&& !this.getCapability(TF2weapons.WEAPONS_CAP, null).isCharging()) {
		...
		// "+this.getHeldItem(InteractionHand.MAIN_HAND).getTagCompound().getBoolean("Zoomed")+"
		// "+this.world.isRemote);
		 ...
		 * getAttackTarget())&&){
		 * ((ItemRangedWeapon)this.getHeldItem(InteractionHand.MAIN_HAND).getItem()).
		 * altUse(getHeldItem(InteractionHand.MAIN_HAND), this, worldObj); } else
		 * if(this.getHeldItem(InteractionHand.MAIN_HAND).getTagCompound().getBoolean(
		 * "Zoomed")){
		 * ((ItemRangedWeapon)this.getHeldItem(InteractionHand.MAIN_HAND).getItem()).
		 * altUse(getHeldItem(InteractionHand.MAIN_HAND), this, worldObj); }
		 */
