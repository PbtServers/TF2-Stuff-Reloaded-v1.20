...
public class EntityPyro extends EntityTF2Character {
	...
	public EntityPyro(Level par1World) {
		super(par1World);
	...
	protected void addWeapons() {
		...
		if (ItemFromData.getData(this.getItemStackFromSlot(EquipmentSlot.HEAD)).getName().equals("head_prize")
	...
	public void onLivingUpdate() {
		...
		if (!this.world.isRemote && this.getAttackTarget() != null) {
			...
			if (weapon.getItem() instanceof ItemFlameThrower
				...
				this.addPotionEffect(new MobEffectInstance(TF2weapons.stun, 40, 1));
				this.addPotionEffect(new MobEffectInstance(TF2weapons.noKnockback, 40, 0));
				TF2Util.addAndSendEffect(this, new MobEffectInstance(TF2weapons.uber, 40, 0));
