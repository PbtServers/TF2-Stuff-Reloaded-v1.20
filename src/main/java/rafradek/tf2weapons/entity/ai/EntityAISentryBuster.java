...
public class EntityAISentryBuster extends EntityAIBase {
	...
	public boolean shouldExecute() {
		LivingEntity entitylivingbase = this.attacker.target;
	...
	public boolean shouldContinueExecuting() {
		...
		if (target == null) {
			...
			return !(entitylivingbase instanceof Player) || !((Player) entitylivingbase).isSpectator()
					&& !((Player) entitylivingbase).isCreative();
		}
	}
