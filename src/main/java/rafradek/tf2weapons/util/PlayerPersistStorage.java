...
public class PlayerPersistStorage implements INBTSerializable<CompoundTag> {
	...
	public Tuple<UUID, CompoundTag>[] buildings = new Tuple[4];
	...
	public static PlayerPersistStorage get(Level world, UUID uuid) {
