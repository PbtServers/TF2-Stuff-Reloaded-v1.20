...
public class PropertyType<T> implements JsonDeserializer<T> {
	...
	public static final PropertyType<String> HIT_WORLD_SOUND = new PropertyType<>(69, "Hit Level sound", String.class);
	...
	public static final PropertyType<Boolean> TEMPLATE = new PropertyType<>(88, "StructureTemplate", Boolean.class);
